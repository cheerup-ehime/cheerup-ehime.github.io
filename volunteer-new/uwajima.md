...
last_modified_at: 2018-08-14 09:34:53 +0900
header:
...
災害ボランティアセンターはお休みですが、その他の団体は活動を継続しています。詳細は各団体までお問い合わせください。

お盆休み中は、吉田町立間の**ＪＡえひめ南本所味楽共同選果場**が駐車場として開放されます(8/12-15)

<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2389.6151549856704!2d132.54016165599762!3d33.29421569223428!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x354589cfc87a6aeb%3A0xb3bc2996664adc8c!2z77yq77yh44GI44Gy44KB5Y2X5pys5omA5ZGz5qW95YWx5ZCM6YG45p6c5aC0!5e0!3m2!1sja!2sjp!4v1533941588220" width="350" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>

## 募集状況

![最新の募集状況](/assets/images/volunteer_headcount/宇和島市_volunteer_headcount_diff_recent.png)

宇和島市災害ボランティアセンター(VC)は8/4からボランティア募集要項を以下のように変更しました。

- 個人：**四国圏域から募集**
- 団体（ボランティアバス含む）：**全国から募集**
    - (**ボランティアバスは8/31まで延長され、8/17から8/31までの運行を募集しています。**)
    - 一日４５でで）
- 1日あたり：**350名**まで
...
宇和島市吉田町に被害は集中しています。被害は**広範囲**に渡り、**重機が入らないと手に負えない箇所**もあり、手付かずの場所も多く、まだまだ多くの人手を必要としています。
...
甚大な被害を受けている宇和島市吉田町は、**西予宇和IC**を降ります。
...
1. ~~松山市に滞在して[松山発のボランティアバス](#ボランティアバスを使う)をご利用して参加する~~(8/12までのバスは締め切られました。その後の運行は未でです)
2. NPO[ユナイテッド・アース](#ユナイテッド・アースで活動する)に参加する
3. NGO[災害NGO結](#災害NGO結で活動する)に参加する
4. [現地のボランティアグループ](#現地ボランティアグループで活動する)に参加する
...
すべての方法で申し込みが可能です。
ただし、災害VCへの個人の申し込みは、団体参加との兼ね合いで、**定員が埋まり締め切られてしまう**可能性が高でです。
そのため、**災害VC以外の団体への参加**を念頭においておく必要があります。
...
### ボランティアバス経由での活動目安
ボランティアバをを利用したボランティア活動の行程目安は以下の通りです。
...
災害NGO結（ゆい）さんが、宇和島市での活動メンバーを[募集](http://ngoyui.com/archives/1838)しています。

> 長期的な支援が必要になる被災地ですが、できるだけ必要な時に必要な支援がとどけられる体制を維持するため、
> 地元支援団体のサポートにも力を入れています。
> それぞれの支援メニューにあわせて一緒に活動していくには、関係性も重要な要素です。
> ボランティアセンターの活動よりちょっとだけ長く、できれば長期的・継続的に関われる方を探しています。
> そのため、宿泊拠点の整備やボランティア募集を行っています。

こちらの[登録フォーム](https://goo.gl/9sPtpo)からお申込みください。

## 現地ボランティアグループで活動する

現在、連絡がとれる現地ボランティアグループは以下のとおりです。他にも情報・掲載したいグループは、チアアップえひめの[メール](mailto:cheerup.ehime@gmail.com)までご連絡くださいませ。

現地ボランティアの活動エリアについては[吉田町の現状（8/6時点）を解説するページ](/volunteer-new/yoshida/)を参考にしてください。

### **チームサクボ**

チームサクボは**吉田町立間中組**を中心にボランティア活動を続けている有志のボランティアグループです。災害VC公認のグループなので、ボランティア保険も加入できます。災害VCに登録窓口も設定されています。
...
お盆も活動されるそうなので、お盆休み中のボランティア活動を希望される方はご連絡ください。
